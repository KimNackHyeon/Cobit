  ...
  data() {
    return {
      story: { 
        ...
        second: "바이러스를 물리쳐야 마을을 구출할 수 있다! <br> 어떻게 해야할까? <br> 바이러스를 물리칠 수 있는 다양한 방법을 알아보자!"
      },
      goal: {
        ...
        second: "<ul><li>반복문을 사용하여 미션을 해결할 수 있다.</li> <br><li>상황에 따라 조건문을 사용하여 이동을 제어할 수 있다.</li><br><li>바이러스를 예방하는 방법에 대해 알 수 있다.</li></ul>"
      },
      showModal: false,
      showModal2: false,
      mapInform: [],
