...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-633b72a7", Component.options)
  } else {
    hotAPI.reload("data-v-633b72a7", Component.options)
  }
...
var render = function() {
  ...
  return _c(
    ...
    [
      ...
      _vm._v(" "),
      _c("span", [_vm._v(_vm._s(_vm.runtimeTranscription))])
    ],
    2
  )
}
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-633b72a7", esExports)
  }
}
